...
} as const satisfies IconRecord

type Icons = keyof typeof icons
type IconRecord = Record<string, (props: ComponentProps<"svg">) => VNode>

export const Icon = ({
  icon,
  ...props
}: { icon: Icons } & ComponentProps<"svg">) => {
  const Selected = icons[icon as Icons]
